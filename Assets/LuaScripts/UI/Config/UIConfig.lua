...
local UIModule = {
    ...
    UIStudyMain = require "UI.UIStudyMain.UIStudyMainConfig",
    UIAnotherTest = require "UI.UIAnotherTest.UIAnotherTestConfig",
    UIAnotherTest2 = require "UI.UIAnotherTest2.UIAnotherTest2Config",
}
